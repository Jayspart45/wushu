    ...
    return (
        <div className='Main '>
            ...
            <div>
                ...
                <p>Wushu is the recognized sport in Tamil nadu . Every year the Wushu Association of Tamil nadu organizes a state match to find the player to represent in the National Level Wushu Tournaments. Tamil nadu Wushu Association is recognized by the Tamil nadu olympic Association, Sports Development Authority of India, Department of Youth Affairs & Sports Ministry of Human Resource Development, Govt. of India, Indian Olympic Association .It is affiliated to the Wushu Association of India.</p>
                <h2>WUSHU:</h2>
                <p>"Wushu" is the Chinese term for "martial arts" (武 "Wu" = military or martial, 術 "Shu" = art). In contemporary times, Wushu has become an international sport under the International Wushu Federation (IWUF), which holds the World Wushu Championships every two years. Wushu is an official event at the Asian Games, Southeast Asian Games, World Combat Games, and in various other multi-sport events.</p>
                <h2>Sanda(Sanshaou):</h2>
                <p>Sanshou or an "unsanctioned fight" is a Chinese self-defense system and combat sport. Sanshou is a martial art which was originally developed by the Chinese military based upon the study and practices of traditional Kung fu and modern combat fighting techniques; it combines full-contact kickboxing, which include close range and rapid successive punches and kicks, with wrestling, takedowns, throws, sweeps, kick catches, and in some competitions, even elbow and knee strikes.
                    ...
                    This curriculum was developed with reference to traditional Chinese martial arts. This general Sanshou curriculum varies in its different forms, as the Chinese government developed a version for civilians for self-defense and as a sport.</p>
                <h2>Taolu:</h2>
                <p>Taolu, refers to the set routine (form) practice component of wushu. Taolu routines comprise of a continuously connected set of pre-determined techniques, choreographed according to certain principles and philosophies which incorporate techniques and stylistic principles of attack and defense.
                    These include hand techniques, leg techniques, jumps, sweeps, stances & footwork, seizing, throwing & wrestling, balances etc. Traditionally, Taolu routines were originally compiled to preserve the techniques and tactics of a particular lineage or system, and would gradually improve a practitioner's flexibility, stamina, strength, speed, balance and co-ordination, and would "imprint" a tactical order into practitioners. Taolu routines include individual routines and group routines, as well as partner/duel routines with 2 or more practitioners involved. They have a rich and diverse content utilizing a wide variety of techniques and includes both bare-handed routines and those performed with weapons.
